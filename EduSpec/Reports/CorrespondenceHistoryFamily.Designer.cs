...
{
    partial class CorrespondenceHistoryFamily
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CorrespondenceHistoryFamily));
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[DateSent]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[CommunicationFormDesc]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[FamilyCode]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[ExternalAccNo]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[CellOrRecipient]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[IsSent]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[RPT_CorrespondenceHistoryFamily].[Error]")});
            ...
            storedProcQuery1.Name = "RPT_CorrespondenceHistory_CommunicationForm_Picklist";
            storedProcQuery1.StoredProcName = "RPT_CorrespondenceHistory_CommunicationForm_Picklist";
            storedProcQuery2.Name = "RPT_CorrespondenceHistory_FormType_Picklist";
            storedProcQuery2.StoredProcName = "RPT_CorrespondenceHistory_FormType_Picklist";
            storedProcQuery3.Name = "RPT_CorrespondenceHistoryFamily";
            ...
            queryParameter4.Value = new DevExpress.DataAccess.Expression("?FormType", typeof(int));
            queryParameter5.Name = "@CommunicationFormTypeID";
            queryParameter5.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter5.Value = new DevExpress.DataAccess.Expression("?Form", typeof(int));
            ...
            storedProcQuery3.StoredProcName = "RPT_CorrespondenceHistoryFamily";
            ...
            this.sqlDataSource1});
            this.DataMember = "RPT_CorrespondenceHistoryFamily";
